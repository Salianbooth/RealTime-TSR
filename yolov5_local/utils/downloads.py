...
def attempt_download(file, repo="ultralytics/yolov5_local", release="v7.0"):
    ...
    if not file.exists():
        ...
        # GitHub assets
        assets = [f"yolov5_local{size}{suffix}.pt" for size in "nsmlx" for suffix in ("", "6", "-cls", "-seg")]  # default
        try:
