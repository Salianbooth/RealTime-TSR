...
Usage:
    import torch
    model = torch.hub.load('ultralytics/yolov5_local', 'yolov5s')  # official model
    model = torch.hub.load('ultralytics/yolov5_local:master', 'yolov5s')  # from branch
    model = torch.hub.load('ultralytics/yolov5_local', 'custom', 'yolov5s.pt')  # custom/local model
...
def custom(path="path/to/model.pt", autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ...
        model = torch.hub.load('ultralytics/yolov5_local', 'custom', 'yolov5s.pt')
...
def yolov5s(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Example:
        ...
        model = torch.hub.load('ultralytics/yolov5_local:master', 'yolov5s')
...
def yolov5m(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Usage Example:
        ...
        model = torch.hub.load('ultralytics/yolov5_local', 'yolov5m')  # Load YOLOv5-medium from Ultralytics repository
        model = torch.hub.load('ultralytics/yolov5_local:master', 'yolov5m')  # Load from the master branch
        model = torch.hub.load('ultralytics/yolov5_local', 'custom', 'yolov5m.pt')  # Load a custom/local YOLOv5-medium model
...
def yolov5l(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Examples:
        ```python
        import torch
        model = torch.hub.load('ultralytics/yolov5_local', 'yolov5l')
        ```
...
def yolov5x(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Example:
        ```python
        import torch
        model = torch.hub.load('ultralytics/yolov5_local', 'yolov5x')
        ```
...
def yolov5s6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Usage:
        ...
        model = torch.hub.load('ultralytics/yolov5_local', 'yolov5s6')
        model = torch.hub.load('ultralytics/yolov5_local:master', 'yolov5s6')  # load from a specific branch
        model = torch.hub.load('ultralytics/yolov5_local', 'custom', 'path/to/yolov5s6.pt')  # custom/local model
...
def yolov5m6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Example:
        ...
        model = torch.hub.load('ultralytics/yolov5_local', 'yolov5m6')
        ```
...
def yolov5l6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Example:
        ```python
        import torch
        model = torch.hub.load('ultralytics/yolov5_local', 'yolov5l6')  # official model
        model = torch.hub.load('ultralytics/yolov5_local:master', 'yolov5l6')  # from specific branch
        model = torch.hub.load('ultralytics/yolov5_local', 'custom', 'path/to/yolov5l6.pt')  # custom/local model
...
def yolov5x6(pretrained=True, channels=3, classes=80, autoshape=True, _verbose=True, device=None):
    ...
    Example:
        ```python
        import torch
        model = torch.hub.load('ultralytics/yolov5_local', 'yolov5x6')  # load the YOLOv5-xlarge-P6 model
        ```
