...
model = torch.hub.load("ultralytics/yolov5_local", "yolov5s")  # 默认：yolov5s
...
model = torch.hub.load("ultralytics/yolov5_local", "custom", "yolov5m-seg.pt")
```
...
```python
# 从 PyTorch Hub 加载模型
model = torch.hub.load("ultralytics/yolov5_local", "custom", "yolov5s-cls.pt")
```
